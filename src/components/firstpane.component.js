    ...
    return (
      ...
      >
        ...
        <div className="row">
          ...
          <div className="col mt-8">
            <p
              ...
              style={{ fontFamily: "Inter", fontSize: "18px", color: "black" }}
            >
              Sent hundreds of applications but never heard back?
              <br /> You need
            </p>
            <h1
              className="text-right"
          ...
          <div className="col-6">
            <img
              src={annie}
              style={{ maxWidth: "50%", boxShadow: "30px -30px 0 0 black", marginLeft:"15%" }}
        ...
        <p
          ...
          class="text-center"
        >
          In summer of 2018, I sent 70-80 job applications but received 0<br />
